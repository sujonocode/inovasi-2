...
<section id="features" class="features py-5">
    <div class="container">
        <h3 class="section-title text-center mb-5">Cari data atau konsultasi? Semua lebih mudah di BPS Kabupaten Tanggamus!</h3>
        <div class="row g-4 justify-content-center">
            <div class="col-lg-4 col-md-4">
                <div class="card-flip" onclick="this.classList.toggle('flipped')">
                    <div class="card-inner">
                        <div class="card-front text-center card-blue text-white">
                            <i class="fas fa-search fa-3x mb-3"></i>
                            <h4 class="card-title">Cari Data Bareng Ladista</h4>
                            <p class="card-text">Temukan data statistik akurat dan kredibel</p>
                        </div>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="card-flip" onclick="this.classList.toggle('flipped')">
                    <div class="card-inner">
                        <div class="card-front text-center card-green text-white">
                            <i class="fas fa-comments fa-3x mb-3"></i>
                            <h4 class="card-title">Konsultasi Data Statistik</h4>
                            <p class="card-text">Dapatkan bantuan langsung dari tim BPS Kabupaten Tanggamus</p>
                        </div>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="card-flip" onclick="this.classList.toggle('flipped')">
                    <div class="card-inner">
                        <div class="card-front text-center card-orange text-white">
                            <i class="fas fa-book-open fa-3x mb-3"></i>
                            <h4 class="card-title">Baca Publikasi BPS</h4>
                            <p class="card-text">Jelajahi publikasi statistik terbaru kami</p>
                        </div>

...
<section class="sdi-section container mt-5 mb-5">
    <h2 class="text-center">Modul 3. Proses Menghasilkan Data</h2>
    <p class="sdi-description">
        Proses menghasilkan data dilakukan melalui tahapan pengumpulan, pengolahan, analisis, dan diseminasi, dengan menjunjung tinggi prinsip akurasi, objektivitas, serta keterandalan, agar data yang dihasilkan dapat menjadi dasar kebijakan yang tepat.
    </p>

    <div class="flow-container">
        <a href="<?= base_url('digistatdescan/pretest3') ?>" class="flow-step">
        ...
        <a href="<?= base_url('digistatdescan/materi3') ?>" class="flow-step">
            <div class="flow-badge">2</div>
            <div class="flow-label">Materi</div>
            <p class="flow-desc">Pelajari proses menghasilkan data secara interaktif dan mudah dipahami.</p>
        </a>
        ...
        <a href="<?= base_url('digistatdescan/posttest3') ?>" class="flow-step">
    ...
    <div class="modal fade" id="klaimModal" tabindex="-1" aria-labelledby="klaimModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="claimForm" action="<?= base_url('descanklaim/simpan3') ?>" method="post" target="_blank">

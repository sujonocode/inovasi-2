...
<section class="sdi-section container mt-5 mb-5">
    <h2 class="text-center">Modul 2. Penyelenggaraan Kegiatan Statistik</h2>
    <p class="sdi-description">
        Penyelenggaraan kegiatan statistik dilakukan secara sistematis mulai dari perencanaan, pelaksanaan lapangan, pengolahan, hingga publikasi, untuk menghasilkan data yang valid, terpercaya, dan bermanfaat bagi pemerintah, akademisi, pelaku usaha, maupun masyarakat luas.
    </p>

    <div class="flow-container">
        <a href="<?= base_url('digistatdescan/pretest2') ?>" class="flow-step">
        ...
        <a href="<?= base_url('digistatdescan/materi2') ?>" class="flow-step">
            <div class="flow-badge">2</div>
            <div class="flow-label">Materi</div>
            <p class="flow-desc">Pelajari penyelenggaraan kegiatan statistik secara interaktif dan mudah dipahami.</p>
        </a>
        ...
        <a href="<?= base_url('digistatdescan/posttest2') ?>" class="flow-step">
    ...
    <div class="modal fade" id="klaimModal" tabindex="-1" aria-labelledby="klaimModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="claimForm" action="<?= base_url('descanklaim/simpan2') ?>" method="post" target="_blank">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="instansi_select" class="form-control" required>
                                ...
                                <option value="Pekon Gisting Permai (Kecamatan Gisting, Kabupaten Tanggamus)">Pekon Gisting Permai (Kecamatan Gisting, Kabupaten Tanggamus)</option>
                                <option value="Pekon Landbaw (Kecamatan Gisting, Kabupaten Tanggamus)">Pekon Landbaw (Kecamatan Gisting, Kabupaten Tanggamus)</option>
                                <option value="Pekon Margodadi (Kecamatan Sumberejo, Kabupaten Tanggamus)">Pekon Margodadi (Kecamatan Sumberejo, Kabupaten Tanggamus)</option>
                                <option value="Pekon Srikaton (Kecamatan  Semaka, Kabupaten Tanggamus)">Pekon Srikaton (Kecamatan Semaka, Kabupaten Tanggamus)</option>
                        ...
                        <div class="mb-3" id="instansi-lainnya" style="display:none;">
                            <input type="text" id="instansi_lainnya" class="form-control" placeholder="Desa xxx (Kecamatan xxx, Kabupaten xxx)">
                        </div>

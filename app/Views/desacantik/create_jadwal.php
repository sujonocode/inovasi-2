    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="form-section">
                <h2 class="text-center mb-4">Formulir Jadwal Pembinaan Desa Cantik</h2>
                <form onsubmit="return validateCheckboxes()" action="/desa_cantik/store" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="<?= base_url('desa_cantik/manage') ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Kembali</a>

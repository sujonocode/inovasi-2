<div class="container my-5">
    <div class="row mb-4">
        <div class="col text-center">
            <h2 class="fw-bold section-title">Jadwal Pembinaan Statistik Sektoral</h2>
        </div>
    </div>
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: <?= json_encode(array_map(function ($jadwalStatistikSektoral) {
                        return [
                            ...
                            'allDay' => false,
                            'extendedProps' => [
                                'opd' => $jadwalStatistikSektoral['opd'],
                                'waktu' => $jadwalStatistikSektoral['waktu_start'] . " s.d. " . $jadwalStatistikSektoral['waktu_end'] . " WIB",
                                'kontak' => $jadwalStatistikSektoral['kontak'],
                                'pengingat' => $jadwalStatistikSektoral['pengingat'],
                                'tempat' => $jadwalStatistikSektoral['tempat'],
            ...
            eventClick: function(info) {
                ...
                document.getElementById('modalEventPlace').textContent = info.event.extendedProps.tempat || 'N/A';
                document.getElementById('modalEventOpd').textContent = info.event.extendedProps.opd || 'N/A';

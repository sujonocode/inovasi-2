...
<body>
    ...
    <div class="isi">
        Telah mengikuti dan menyelesaikan seluruh rangkaian pembelajaran statistik <strong>(Modul 2 - Kualitas Data)</strong> melalui aplikasi pembelajaran BPS Kabupaten Tanggamus <strong>(Digistat)</strong>, yang terdiri dari:
        <ol>
            <li>Pretest</li>

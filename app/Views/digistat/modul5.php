...
<section class="sdi-section container mt-5 mb-5">
    <h2 class="text-center">Modul 5. Sistem Statistik Nasional (SSN)</h2>
    <p class="sdi-description">
        Sistem Statistik Nasional menyatukan berbagai lembaga penghasil data dalam satu kerangka kerja. Melalui SSN, kita bisa menghasilkan data yang seragam, terintegrasi, dan mendukung pembangunan nasional yang berbasis bukti.
    </p>

    <div class="flow-container">
        <a href="<?= base_url('digistat/pretest5') ?>" class="flow-step">
        ...
        <a href="<?= base_url('digistat/materi5') ?>" class="flow-step">
            <div class="flow-badge">2</div>
            <div class="flow-label">Materi</div>
            <p class="flow-desc">Pelajari sistem statistik nasional secara interaktif dan mudah dipahami.</p>
        </a>
        ...
        <a href="<?= base_url('digistat/posttest5') ?>" class="flow-step">
    ...
    <div class="modal fade" id="klaimModal" tabindex="-1" aria-labelledby="klaimModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="claimForm" action="<?= base_url('klaim/simpan5') ?>" method="post" target="_blank">

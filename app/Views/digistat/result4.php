    ...
    <div class="score-container text-center">
        ...
        <div class="mt-4">
            <?php if ($type == 'Pre Test'): ?>
                <a href="<?= base_url('digistat/materi4') ?>" class="btn btn-lg btn-gold">Lanjut ke Materi</a>
            <?php else: ?>
                <a href="<?= base_url('digistat/modul4') ?>" class="btn btn-lg btn-gold">Kembali ke Halaman Awal</a>
            <?php endif ?>
        </div>
    </div>
</div>
